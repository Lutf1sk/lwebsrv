...
typedef void (*stream_fn_t)(lt_io_callback_t callb, void* usr, connection_t* conn);

#define template_stream(name) void __template_stream_##name(lt_io_callback_t __callb, void* __usr, connection_t* conn)
